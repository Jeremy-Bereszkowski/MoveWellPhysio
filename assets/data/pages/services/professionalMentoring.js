import {companyName, email, ProfessionalMentorBackground} from "../../global";
...
const ProfessionalMentoringData = {
    ...
    body: {
        ...
        strings: [
            "Director of Physiotherapy, Yasha, along with the " + companyName + " team, run weekly mentoring sessions. We’re passionate about sharing current knowledge and literature surrounding physiotherapy, health and fitness.",
            ...
            "If you would like to join an online mentoring session, please contact MoveWell at " + email,
        ]
    }
}
